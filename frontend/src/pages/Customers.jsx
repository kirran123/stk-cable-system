            ...
            <table>
              <thead>
                <tr>
                  ...
                  }} checked={selectedIds.length === filteredCustomers.length && filteredCustomers.length > 0} /></th>
                  <th>Name</th>
                  <th>Place</th>
                  <th>Phone</th>
                  <th>Box No</th>
                  ...
                  <tr key={customer.id}>
                    ...
                    <td>
                      <button
                        ...
                        onClick={() => handleToggle(customer.id, 'status', customer.status)}
                      >
                        {customer.status}
                      </button>
                    </td>
                    <td>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInlineChange(customer.id, 'totalAmount', e.target.value)}
                        />
                        {inlineEdits[`${customer.id}-totalAmount`] !== undefined && (
                          <button
                    ...
                    <td>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                        ...
                        <input
                          ...
                          onChange={(e) => handleInlineChange(customer.id, 'monthlyPayment', e.target.value)}
                        />
                        {inlineEdits[`${customer.id}-monthlyPayment`] !== undefined && (
                          <button
                            className="btn btn-success"
                            style={{ padding: '0.25rem', fontSize: '1rem', minWidth: '32px' }}
                    ...
                    <td>
                      <button
                        ...
                        style={{ cursor: 'pointer' }}
                        onClick={() => handleToggle(customer.id, 'paid', customer.paid)}
                      >
                        {customer.paid}
                      </button>
                    </td>
